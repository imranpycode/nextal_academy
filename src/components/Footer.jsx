        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand anim-image delay-1">
            ...
            <div className="footer-socials">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="social-link" style={{ color: 'rgba(255,255,255,0.75)', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#FFFFFF'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.75)'} aria-label="X (Twitter)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="social-link" style={{ color: 'rgba(255,255,255,0.75)', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#0A66C2'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.75)'} aria-label="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-col anim-text delay-4">
            ...
            <div className="footer-contact-item">
              <Mail size={18} />
              <a href="mailto:admissions@nextalacademy.com" style={{ color: 'inherit', textDecoration: 'none' }}>
                admissions@nextalacademy.com
              </a>
            </div>
          </div>
